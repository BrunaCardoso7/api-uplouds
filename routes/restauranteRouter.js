...
import { DeleteRestaurante, create, getByIdRestaurante, getRestarantes, updateRestaurantes } from '../controllers/restauranteController.js'
...
restauranteRouter.get('/', UserHasRestauranteMiddleware, getRestarantes)
